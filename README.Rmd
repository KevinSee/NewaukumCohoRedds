...
This repository contains the data and code for simulating GRTS surveys for Coho redds on the Newaukum river. The initial goal is to test various GRTS study designs and test them against several years of census count redd surveys.
...
The **analysis** directory contains:
  ...
  - [:file\_folder: data](/analysis/data): Data used in the analysis.
      * [:file\_folder: raw_data](/analysis/data/raw_data) contains tag lists and data downloaded from PTAGIS or other sources
      * [:file\_folder: derived_data](/analysis/data/derived_data) contains analysis products that have been saved along the way, including model fits and cleaned up habitat and fish data.
